...
import { createPracticeSession, extendPracticeSession, gradeAnswer, restorePracticeQuestions, selectPracticeQuestions, selectRandomQuestions, selectReviewQuestions, selectUnseenQuestions } from './practice'
...
export function VocabularyPractice({ subjectId, vocabulary, onBack, onAwardXp }: { subjectId: string; vocabulary: VocabularyBank; onBack: () => void; onAwardXp: (amount: 1 | 3, correct: boolean) => void }) {
